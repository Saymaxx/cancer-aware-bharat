...
from app.routers import auth, blogs, campaign_requests, donations, enquiries, events, feedback, hospitals, notifications, patient_records, patients, volunteers
...
_ROUTERS = (auth.router, enquiries.router, hospitals.router, notifications.router, volunteers.router, patients.router, events.router, blogs.router, patient_records.router, donations.router, feedback.router, campaign_requests.router)
