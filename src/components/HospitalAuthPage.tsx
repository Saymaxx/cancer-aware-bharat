        ...
        {mode === 'login' ? (
          <div className="max-w-xl mx-auto bg-white rounded-3xl p-6 sm:p-10 border border-slate-200/80 shadow-lg space-y-6">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              {/* Hint Card */}
              <div className="p-3.5 bg-slate-50 border border-slate-200 rounded-2xl text-xs space-y-1 text-slate-900">
                <p className="font-bold text-[11px] uppercase tracking-wider text-[#063b42] flex items-center gap-1.5">
                  <Key className="w-3.5 h-3.5 text-primary-container" /> Demo Approved Credentials:
                </p>
